// to do: queen, rook, castle(both king and rook)
...
document.querySelectorAll('.box').forEach(item => {
    ...
    item.addEventListener('click', function () {
        ...
        if (tog % 2 !== 0) {
            document.getElementById('tog').innerText = "Fehér következik"
            whosTurn('W')
        }
        if (tog % 2 == 0) {
            document.getElementById('tog').innerText = "Fekete következik"
            whosTurn('B')
        }
